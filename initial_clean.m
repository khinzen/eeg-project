function [sleep_result] = initial_clean(spindles, sleep)
% this program roughly classifies spindle vs non spindle sleep and is
% supplmented by clean_classifier.m
